...
Download `netllm-<version>-windows-x64.zip` from [GitHub Releases](https://github.com/matthewdcage/llm-swarm-router/releases/latest) (e.g. `netllm-0.2.3-windows-x64.zip` from [v0.2.3](https://github.com/matthewdcage/llm-swarm-router/releases/tag/v0.2.3), **alpha** package for Windows).
