...
Latest: [v0.2.3.1](https://github.com/matthewdcage/llm-swarm-router/releases/tag/v0.2.3.1) (macOS clean upgrade; Linux/Windows **alpha**) · [All releases](https://github.com/matthewdcage/llm-swarm-router/releases)
