...
Download from [GitHub Releases](https://github.com/matthewdcage/llm-swarm-router/releases/latest) (e.g. [v0.2.3](https://github.com/matthewdcage/llm-swarm-router/releases/tag/v0.2.3), **alpha** packages for Linux):
...
```bash
sudo dpkg -i netllm_0.2.3_amd64.deb
# or
sudo rpm -Uvh netllm-0.2.3-1.x86_64.rpm
```
