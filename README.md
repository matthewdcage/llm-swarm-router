...
<tr><td><b>Host catch-all model pools</b></td><td><code>[routing.model_pools.&lt;name&gt;]</code> lets specific hosts accept <i>any</i> requested model name, bypassing alias matching entirely, as long as the host serves one of the pool's allowed models — useful for a big-model box that should absorb overflow/misnamed requests instead of 404ing.</td></tr>
